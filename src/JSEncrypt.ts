...
export default class JSEncrypt {
     ...
     * @param str
     */
    public subsectionDecrypt(str:string) {
        try {
            return this.getKey().subsectionDecrypt(b64tohex(str));
        } catch (ex) {
            return false;
        }
    }
     ...
     * @param str
     */
    public subsectionEncrypt(str:string) {
        try {
            return hex2b64(this.getKey().subsectionEncrypt(str));
        } catch (ex) {
            return false;
        }
    }
